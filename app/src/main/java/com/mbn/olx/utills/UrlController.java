...
import com.mbn.olx.utills.Network.AuthenticationInterceptor;
...
public class UrlController {
    ...
    private static String IP_ADDRESS = "http://olx.stop4web.com/";//Enter You Ip_Address/DomainName here here
    private static String Purchase_code = "6b7fbc38-9b24-4a26-ab08-9270b0f8aa5d";//Enter the purchase code here
    private static String Custom_Security = "IloveOLX#010";//Enter the Custom Security code here
